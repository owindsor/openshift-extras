...
CONF_DOMAIN="${CONF_PREFIX}.silversaas.com.au"
CONF_APPS_DOMAIN="apps.${CONF_PREFIX}.silversaas.com.au"
CONF_NO_NTP=true
...
ssh-rsa 
KEYS
}
...
{
  # Enable repo with the puddle for broker packages.
  cat > /etc/yum.repos.d/openshift-release.repo <<YUM
[openshift_client]
name=OpenShift Client
baseurl=https://mirror.openshift.com/pub/openshift-origin/release/1/rhel-6/packages/x86_64/
enabled=1
gpgcheck=0
sslverify=false
YUM
